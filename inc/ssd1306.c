...
void ssd1306_draw_full_tank(ssd1306_t *ssd, uint8_t x, uint8_t y){
  bool pintar = true;
...
void ssd1306_draw_empty_tank(ssd1306_t *ssd, uint8_t x, uint8_t y){
  bool pintar = true;
...
void ssd1306_draw_low_tank(ssd1306_t *ssd, uint8_t x, uint8_t y){
  bool pintar = true;
...
void ssd1306_draw_stable_tank(ssd1306_t *ssd, uint8_t x, uint8_t y){
  bool pintar = true;
